...
local _blockers = {
    ...
    {
        coords = vector3(-815.932, 178.175, -77.174),
        p1 = vector2(-794.16589355469, 182.94381713867),
        p2 = vector2(-792.50579833984, 178.6282043457),
        minZ = -85.0,
        maxZ = -40.0
    },
    {
        coords = vector3(-815.932, 178.175, -77.174),
        p1 = vector2(-801.67419433594, 167.74215698242),
        p2 = vector2(-803.08410644531, 166.54364013672),
        minZ = -85.0,
        maxZ = -40.0
    },
    {
        coords = vector3(-815.932, 178.175, -77.174),
        p1 = vector2(-817.71612548828, 181.72563171387),
        p2 = vector2(-816.19598388672, 182.28660583496),
        minZ = -85.0,
        maxZ = -40.0
    },
    {
