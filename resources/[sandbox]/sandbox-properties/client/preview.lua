...
function StartPreview(int)
    ...
    if intData and intData.cameras then
        ...
        InfoOverlay:Show(_previewingInteriorData?.info?.name or "Unknown", _previewingInterior and _previewingInterior[_previewingInteriorCam].name or "???")
...
function EndPreview()
    if _previewingInteriorSwitching then
        return
    end
    _previewingInteriorSwitching = true
    DoScreenFadeOut(250)
...
function PrevPreview()
    if _previewingInterior and _previewingInteriorCam > 1 then
        _previewingInteriorSwitching = true
        _previewingInteriorCam -= 1
...
function NextPreview()
    if _previewingInterior and _previewingInteriorCam < #_previewingInterior then
        _previewingInteriorSwitching = true
        _previewingInteriorCam += 1
